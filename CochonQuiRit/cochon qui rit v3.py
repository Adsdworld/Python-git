...
# bug lors de la boucle--> ok
# bug 2 as pour la queue--> ok
# bug as avec le premier 6--> ok
            ...
            for players in player_list:
                ...
                while True:
                    if data[players+'points'] > 0: #si le joueurs à des points on récupère les choix disponible et on lui demande de choisir des objets
                        ...
                        if choice_available == '':
                            print("{} il vous faut 2 as dans un même lancé pour avoir la queue".format(players))
                            data[players+'points']=0
